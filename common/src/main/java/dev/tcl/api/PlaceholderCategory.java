...
import dev.tcl.impl.PlaceholderCategoryImpl;
...
public interface PlaceholderCategory extends ConfigCategory {
     ...
     */
    BiFunction<Minecraft, TCLScreen, Screen> screen();
    ...
    interface Builder {
         ...
         *
         * @param tooltips Component lines - merged with a new-line on {@link PlaceholderCategory.Builder#build()}.
         */
         ...
         */
        Builder screen(@NotNull BiFunction<Minecraft, TCLScreen, Screen> screenFunction);
