...
import dev.tcl.impl.OptionDescriptionImpl;
...
public interface OptionDescription {
    ...
    static @NotNull OptionDescription orEmpty(@Nullable OptionDescription description) {
    ...
    interface Builder {
         ...
         * @return this builder
         */
        default Builder text(Component... description) {
            return text(Arrays.asList(description));
        }
        ...
        /**
         * Appends empty line to the main description of the option unless it's empty.
         *
         * @return this builder
         * @see Builder#text()
         */
         ...
         * may change that could break compatibility with future versions of TCL.
