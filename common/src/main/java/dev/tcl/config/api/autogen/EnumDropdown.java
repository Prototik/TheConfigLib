 ...
 * An option factory.
 * <p>
 * This creates a regular option with a {@link EnumDropdownControllerBuilder}
 * controller. If the enum implements {@link CyclableEnum}, the allowed values will be used from that,
 * rather than every single enum constant in the class. If not, {@link EnumDropdown#allowedOrdinals()} is used.
 * <p>
