package dev.tcl.config.api.serializer;
...
import dev.tcl.config.impl.serializer.GsonConfigSerializer;
 ...
 * <p>
 * Only fields annotated with {@link SerialEntry} are included in the JSON.
...
public interface GsonConfigSerializerBuilder<T> {
    ...
    /**
     * Sets the GSON instance to use. Overrides all TCL defaults such as:
     * <ul>
     ...
     * <p>
     * By default, TCL sets the GSON with the following options:
     * <ul>
     *     <li>lower_camel_case field naming policy</li>
     *     <li>null serialization</li>
     *     <li>{@link Component}, {@link Style} and {@link Color} type adapters</li>
     * </ul>
     * For example, if you wanted to revert TCL's lower_camel_case naming policy,
