...
public class DoubleSliderController implements ISliderController<Double> {
     ...
     */
    public static final ValueFormatter<Double> DEFAULT_FORMATTER = value -> Component.literal(String.format("%,.2f", value).replaceAll("[\u00a0\u202F]", " "));
     ...
     */
    public DoubleSliderController(Option<Double> option, double min, double max, double interval, ValueFormatter<Double> valueFormatter) {
