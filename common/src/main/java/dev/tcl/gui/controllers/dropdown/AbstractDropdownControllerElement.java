...
public abstract class AbstractDropdownControllerElement<T, U> extends StringControllerElement {
	...
	public AbstractDropdownControllerElement(AbstractDropdownController<T> control, TCLScreen screen, Dimension<Integer> dim) {
	...
	protected void renderDropdownEntry(GuiGraphics graphics, U value, int n) {
		...
		Component text;
		if (entry.isBlank()) {
			text = Component.translatable("tcl.control.text.blank").withStyle(ChatFormatting.GRAY);
		} else {
