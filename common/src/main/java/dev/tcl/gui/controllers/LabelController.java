...
public class LabelController implements Controller<Component> {
    ...
    public class LabelControllerElement extends AbstractWidget {
        ...
        public LabelControllerElement(TCLScreen screen, Dimension<Integer> dim) {
            super(dim);
            this.screen = screen;
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
            ...
            if (isMouseOver(mouseX, mouseY)) {
                TCLScreen.renderMultilineTooltip(graphics, textRenderer, wrappedTooltip, getDimension().centerX(), getDimension().y() - 5, getDimension().yLimit() + 5, screen.width, screen.height);
                    ...
                    if (itemStackContent != null) {
                        ...
                        if (entityContent != null) {
                            ...
                            if (text != null) {
                                ...
                                TCLScreen.renderMultilineTooltip(graphics, textRenderer, multilineText, getDimension().centerX(), getDimension().y(), getDimension().yLimit(), screen.width, screen.height);
                            }
                        }
                    }
                }
        ...
        private void updateTooltip() {
            this.wrappedTooltip = MultiLineLabel.create(textRenderer, option().description().text(), screen.width / 3 * 2 - 10);
        }
