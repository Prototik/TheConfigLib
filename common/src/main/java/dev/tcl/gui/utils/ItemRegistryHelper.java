...
public final class ItemRegistryHelper {
    ...
    public static Stream<ResourceLocation> getMatchingItemIdentifiers(String value) {
        ...
        return BuiltInRegistries.ITEM.holders()
                ...
                .filter(getMatchingItemIdentifiersPredicate(value, sep))
                /*
    ...
    @NotNull
    private static Predicate<ResourceLocation> getMatchingItemIdentifiersPredicate(String value, int sep) {
