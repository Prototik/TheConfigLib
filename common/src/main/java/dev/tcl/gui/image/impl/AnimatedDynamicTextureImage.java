package dev.tcl.gui.image.impl;
...
import dev.tcl.debug.DebugProperties;
...
public class AnimatedDynamicTextureImage extends DynamicTextureImage {
    ...
    public AnimatedDynamicTextureImage(NativeImage image, int frameWidth, int frameHeight, int frameCount, double[] frameDelayMS, int packCols, ResourceLocation uniqueLocation) {
...
//            }
        ...
        return () -> new AnimatedDynamicTextureImage(image, frameWidth, frameHeight, frameCount, frameDelays, cols, uniqueLocation);
    }
