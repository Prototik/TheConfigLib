...
import dev.tcl.gui.RequireRestartScreen;
...
public class GuiTest {
    public static Screen getModConfigScreenFactory(Screen parent) {
        return TheConfigLib.create(ConfigTest.GSON, (defaults, config, builder) -> builder
        ...
        return TheConfigLib.create(ConfigTest.GSON, (defaults, config, builder) -> builder
                        ...
                        .category(ConfigCategory.createBuilder()
                                ...
                                .group(OptionGroup.createBuilder()
                                        ...
                                        .option(Util.make(() -> {
                                            var opt = Option.<Boolean>createBuilder()
                                                    ...
                                                    .description(OptionDescription.createBuilder()
                                                            ...
                                                            .webpImage(new ResourceLocation("tcl_test", "reach-around-placement.webp"))
                                                            .build())
                                                    .binding(
                                                    ...
                                                    .controller(BoolControllerBuilder::create)
                                        ...
                                        .option(Option.<Boolean>createBuilder()
                                                ...
                                                .description(val -> OptionDescription.createBuilder()
                                                        .text(Component.literal("You can customize controllers like so! " + TheConfigLib.SHORT_NAME + " is truly infinitely customizable! This tooltip is long in order to demonstrate the cool, smooth scrolling of these descriptions. Did you know, they are also super clickable?! I know, cool right, " + TheConfigLib.SHORT_NAME + " really is amazing."))
                                                        .image(Path.of("D:\\Xander\\Downloads\\_MG_0860-Enhanced-NR.png"), new ResourceLocation("tcl_test", "f.webp")) // TODO: Add img file to git?
                                                        .build())
                                                .binding(
                                                ...
                                                .controller(opt -> BoolControllerBuilder.create(opt)
                                ...
                                .group(OptionGroup.createBuilder()
                                        ...
                                        .description(OptionDescription.of(Component.literal(TheConfigLib.SHORT_NAME + " can also bind Minecraft options!")))
                                        .option(Option.<Boolean>createBuilder()
                        ...
                        .category(PlaceholderCategory.createBuilder()
                                ...
                                .screen((client, tclScreen) -> new RequireRestartScreen(tclScreen))
                                .build())
                        .save(() -> {
    ...
    private static Screen getWikiGetStarted(Screen parent) {
        return TheConfigLib.createBuilder()
